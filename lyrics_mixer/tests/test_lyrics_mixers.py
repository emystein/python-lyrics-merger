...
def test_two_random_songs_mixer(song1, song2):
	...
	mixer = RandomLyricsMixer(lyrics_api_client)
...
def test_two_random_songs_by_artists_mixer(song1, song2):
	...
	mixer = RandomByArtistsLyricsMixer(lyrics_api_client, song1.title.artist, song2.title.artist)
	mixed_lyrics = mixer.mix_lyrics(lyrics_mix_strategy)
...
def test_two_specific_songs_mixer(song1, song2):
	...
	mixer = SpecificLyricsMixer(lyrics_api_client, song1.title, song2.title)
	mixed_lyrics = mixer.mix_lyrics(lyrics_mix_strategy)
