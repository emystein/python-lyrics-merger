...
def test_mix_with_same_number_of_lines(lyrics_editor):
    song1 = Song(song_title1, Lyrics.with_text('lyrics 1 line 2\nlyrics 1 line 2\n\nlyrics 1 line 3\n\n'))
    song2 = Song(song_title2, Lyrics.with_text('lyrics 2 line 1\nlyrics 2 line 2\n\nlyrics 2 line 3\n\n'))
...
def test_mix_with_first_lyrics_with_2_lines_and_second_lyrics_with_1_line(lyrics_editor):
    song1 = Song(song_title1, Lyrics.with_text('lyrics 1 line 1\nlyrics 1 line 2'))
    song2 = Song(song_title2, Lyrics.with_text('lyrics 2 line 1'))
