...
def test_two_random_songs_picker(song1, song2):
	...
	picker = RandomSongPairPicker(lyrics_api_client)
...
def test_two_random_songs_by_artists_picker(song1, song2):
	...
	picker = RandomByArtistsSongPairPicker(lyrics_api_client, song1.title.artist, song2.title.artist)
	song_pair = picker.pick_song_pair()
...
def test_two_specific_songs_picker(song1, song2):
	...
	picker = SpecificSongPairPicker(lyrics_api_client, song1.title, song2.title)
	song_pair = picker.pick_song_pair()
