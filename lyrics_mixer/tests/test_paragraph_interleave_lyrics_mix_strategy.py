...
def test_mix_with_same_number_of_paragraphs(lyrics_editor):
    ...
    assert mixed_lyrics.lines == ['lyrics 1 first line', 'lyrics 1 second line',
                                  'lyrics 2 first line', 'lyrics 2 second line', 'lyrics 1 third line', 'lyrics 2 third line']
...
def test_mix_with_first_lyrics_with_2_paragraphs_and_second_lyrics_with_1_paragraph(lyrics_editor):
    ...
    assert mixed_lyrics.paragraphs == [
        'lyrics 1 first line', 'lyrics 2 first line']
