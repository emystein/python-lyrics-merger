...
class Dispatcher(object):
    ...
    def mix_two_random_lyrics(self):
        lyrics_mixer = RandomLyricsMixer(self.lyrics_api_client)
        return lyrics_mixer.mix_lyrics(self.lyrics_mix_strategy)

    def mix_random_lyrics_by_artists(self, artist1, artist2):
        lyrics_mixer = RandomByArtistsLyricsMixer(self.lyrics_api_client, artist1, artist2)
        return lyrics_mixer.mix_lyrics(self.lyrics_mix_strategy)

    def mix_two_specific_lyrics(self, song_title1, song_title2):
        lyrics_mixer = SpecificLyricsMixer(self.lyrics_api_client, song_title1, song_title2)
        return lyrics_mixer.mix_lyrics(self.lyrics_mix_strategy)
